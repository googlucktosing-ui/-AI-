...
private:
    ...
    static void MenuTileEventCallback(lv_event_t* e) {
        ...
        auto* board = static_cast<LichuangDevBoard*>(lv_event_get_user_data(e));
        if (board == nullptr) {
            return;
        }
    ...
    void HideMainMenuFromLvgl() {
        ...
        lv_obj_t* target_screen = menu_previous_screen_;
